...
namespace WfmManagementAPI.Models
{
    public class ManagerRepository
    {
        public List<EmployeeDetails> GetDetailsForManagerPage()
        {
            ...
            using (var conn = new SqlConnection("Data Source=SQL201901.softura.com;User ID=ShakthiRM;Password=Shakthi@123;Initial Catalog=Shakthi_TempDB;Connection Timeout=0"))
            {
                conn.Open();
